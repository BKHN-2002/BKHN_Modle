    ...
    <div class="main-container">
        ...
        <table>
            ...
            while ($row = mysqli_fetch_assoc($query_studentQuiz)) {
                ...
                echo "<td> <a href='Course/Course.php?courseId=$courseId&instructorId=$instructorId'>go to course</a> </td>";
                echo "</tr>";
            }
            ?>
        </table>
        ...
        <table>
            ...
            $query_studentQuiz = mysqli_query(
                $connection,
                "SELECT quizzes.name as courseNameForQuiz, quizzes.id as quizId ,quizzes.visibility as visibility
            ...
            while ($row = mysqli_fetch_assoc($query_studentQuiz)) {
                ...
                if ($row['visibility'] != 0) {
                    ...
                    echo "<td>" . '<b>Start in:</b> <br>' . $day . ' ' . $startTimeOfQuiz . '  <hr> <b>End in: </b><br>' . $dayEnd . ' '  . $endTimeOfQuiz .
                        "</td>";
                    echo "<td> <a href='Quizzes/Quiz.php?quizId=$quizId'>attempt now</button> </a>";
                    echo "</tr>";
                }
            }
            ?>
        ...
        <table>
            ...
            while ($row = mysqli_fetch_assoc($query_studentQuiz)) {
                if ($row['visibility'] != 0) {
                    ...
                    echo "<td>" . '<b>Start in:</b> <br>' . $day . ' ' . $startTimeOfQuiz . '  <hr> <b>End in: </b><br>' . $dayEnd . ' '  . $endTimeOfQuiz .
                        "</td>";
                    echo "<td> <a href='Assignmentes/Assignment.php?assignmentId=$assignmentId'>attempt now</a> </td>";
                    echo "</tr>";
                }
            }
            ?>

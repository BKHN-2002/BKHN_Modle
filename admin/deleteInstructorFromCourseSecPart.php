...
if (isset($_POST["submit"]) && isAdmin($conn)) {
    ...
    if (!empty($courseId)) {
        $sql = "DELETE FROM `instructor_course` WHERE courseId = $courseId  and instructorID = $instructorId ";
...
{
    $instructorId = $_GET['instructorId'];
    // $sql = "SELECT id , name from courses WHERE id IN (SELECT studentId FROM student_course WHERE studentId = $stdId  )";
    $sql = "SELECT `id`, `name` FROM `courses` WHERE id IN (SELECT `courseId` FROM `instructor_course` where instructorID = $instructorId )";
                ...
                <form action="" method="post">
                    <div class="courseId-container">
                        ...
                        <div class="ct-select-group ct-js-select-group">
                            <select class="ct-select ct-js-select" name="courseId">
                                <option value=""></option>
                                <?php CourseFiller(); ?>
                            </select>
                        </div>
                    ...
                    <input class="sbmit" type="submit" name="submit" value="delete">
                </form>
            </div>

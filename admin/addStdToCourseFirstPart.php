...
if (isset($_POST["submit"]) && isAdmin($connection)) {
    ...
    if (!empty($courseId)) {
        header('Location:addStdToCourseSecPart.php?courseId=' . $courseId);
    } else {
        $echoCourseExist = "please enter a course ..... ";
    }
}
...
function CourseFiller($connection)
{
                ...
                <form action="" method="post">
                    <div class="courseId-container">
                        ...
                        <div class="ct-select-group ct-js-select-group">
                            <select class="ct-select ct-js-select" name="courseId" id="courseId" onchange="submitAction();">
                                <option value=""></option>
                                <?php CourseFiller($connection); ?>
                            </select>
                        </div>
                    </div>
                    <h4 class="state">

...
if (isset($_POST["submit"])) {
    ...
    if (!empty($courseId)) {
        $sql = "DELETE FROM `student_course` WHERE studentId = $stdId and courseId = $courseId ";
...
function CourseFiller()
{
    ...
    $sql = "SELECT `id`, `name` FROM `courses` WHERE id IN (SELECT `courseId` FROM `student_course` where studentId  = $stdId )";
